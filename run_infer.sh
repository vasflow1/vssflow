...
python \
    main.py \
    --base "./config/vaflow_noise_lip_synch_text.yaml" "./config/vaflow_noise_lip_synch_text_infer.yaml" \
    -f "_lrs2_nolip4dpo" \
    -t False \
    -i True \
    --devices 0,1,2,3 \
...
#     --base "./config/vaflow_sda_dit_noise_clip_mel.yaml" "./config/vaflow_sda_dit_noise_clip_mel_infer.yaml" \
