...
def get_file_label_chem():
    # input
    text_source_path = os.path.join('/home/chengxin/chengxin/vssflow/feature/avhubert/infer_data2/videos')
    file_doc = '/home/chengxin/chengxin/vssflow/feature/avhubert/infer_data2/files/filelist.txt'

    # output
    video_id_path = '/home/chengxin/chengxin/vssflow/feature/avhubert/infer_data2/files/file.list'
    label_path = '/home/chengxin/chengxin/vssflow/feature/avhubert/infer_data2/files/label.list'
    ...
    for video_id in tqdm.tqdm(video_id_list):
        basename = video_id
        speaker, num = basename.rsplit('_', 1)   
        speaker, num = basename.split('_', 1)   # MODIFIEDE BY CX
        lab_path = os.path.join(text_source_path, speaker, video_id + '.lab')
        # lab_path = os.path.join(text_source_path, video_id + '.lab')
    ...
    with open(video_id_path, 'w') as file:
        file.write('\n'.join(video_ids_total) + '\n')
