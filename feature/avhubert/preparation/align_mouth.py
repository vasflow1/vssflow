...
def load_args(default_config=None):
    ...
    parser.add_argument('--video-direc', default='/home/chengxin/chengxin/vssflow/feature/avhubert/infer_data2/videos', help='raw video directory')
    parser.add_argument('--landmark-direc', default='/home/chengxin/chengxin/vssflow/feature/avhubert/infer_data2/landmarks', help='landmark directory')
    parser.add_argument('--filename-path', default='/home/chengxin/chengxin/vssflow/feature/avhubert/infer_data2/files/file.list', help='list of detected video and its subject ID')
    parser.add_argument('--save-direc', default='/home/chengxin/chengxin/vssflow/feature/avhubert/infer_data2/mouth', help='the directory of saving mouth ROIs')
    # -- mean face utils
    parser.add_argument('--mean-face', type=str, default='/home/chengxin/chengxin/vssflow/feature/avhubert/data/20words_mean_face.npy', help='reference mean face (download from: https://github.com/mpc001/Lipreading_using_Temporal_Convolutional_Networks/blob/master/preprocessing/20words_mean_face.npy)')
    # -- mouthROIs utils
    parser.add_argument('--crop-width', default=88, type=int, help='the width of mouth ROIs')
    parser.add_argument('--crop-height', default=88, type=int, help='the height of mouth ROIs')
    ...
    parser.add_argument('--ffmpeg', type=str, default='/data-03/yuyue/anaconda3/envs/DSU/bin/ffmpeg', help='ffmpeg path')
...
if __name__ == '__main__':
    ...
    miss_num = 0
    for filename_idx, filename in enumerate(tqdm(fids, desc = f"{args.rank}")):
        speaker = filename.split('_')[0]
        video_pathname = os.path.join(args.video_direc, speaker, filename+'.mp4')
        # video_pathname = os.path.join(args.video_direc, speaker, filename+'.mpg')
