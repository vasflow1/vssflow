...
def count_frames(fids, audio_dir, video_dir):
    ...
    for fid in tqdm(fids):
        speaker, id = fid.split('_', 1)
        wav_fn = f"{audio_dir}/{speaker}/{fid}.wav"
        video_fn = f"{video_dir}/{speaker}/{fid}.mp4"
...
if __name__ == '__main__':
    ...
    parser.add_argument('--root', type=str, default='/home/chengxin/chengxin/vssflow/feature/avhubert/infer_data2/avhubert_features', help='root dir')
    ...
    audio_dir = '/home/chengxin/chengxin/vssflow/feature/avhubert/infer_data2/videos'
    video_dir = '/home/chengxin/chengxin/vssflow/feature/avhubert/infer_data2/videos'
