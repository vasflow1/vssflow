...
if __name__ == "__main__":
    ...
    parser.add_argument("tsv_dir", default='/nfs-02/yuyue/visualtts/DSU-AVO-main/avhubert/data/all_data/all_data.tsv')
    parser.add_argument("split")
    parser.add_argument("ckpt_path")
    parser.add_argument("layer", type=int)
    parser.add_argument("nshard", default=0, type=int)
    parser.add_argument("rank", default=0, type=int)
    parser.add_argument("feat_dir", default='/nfs-02/yuyue/visualtts/DSU-AVO-main/avhubert/data/av_feature')
