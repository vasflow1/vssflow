...
class G2p_en:
    ...
    def __call__(self, text) -> List[str]:
        ...
        phones = self.g2p(text)     # 需要MODIFY一下__call__，可以吧特殊字符设置成 <blank>
        if self.no_space:
...
def extract_phoneme():
    in_dir = "/home/chengxin/chengxin/dataset/V2C/speakers"
    phoneme_path = "/home/chengxin/chengxin/dataset/V2C/preprocessed_data/phoneme"  # 字典的地址
    ...
    for lab in tqdm(lab_list):
        ...
        file_name = lab.split('/')[-1].split('.')[0]
        phoneme_seq = " ".join(phonemes)
        re.append(f"{file_name} {phoneme_seq}\n")
        # print(phonemes)
...
if __name__ == "__main__":
    ...
    # # process text
    text = "I'VE GOTTA DEAL WITH THE K I D."
